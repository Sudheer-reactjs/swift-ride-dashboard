          ...
          <Table className="w-full overflow-auto hover:cursor-pointer min-w-[1300px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="">Expected Date</TableHead>
              ...
              {paginatedVehicles.map((vehicle, index) => (
                ...
                >
                  <TableRow key={index} className="bg-black-800 text-xs">
                    ...
                    <TableCell className="">{vehicle.number}</TableCell>
                    <TableCell >
                    ...
                    <TableCell className="">
                     <div className="flex items-center min-w-0 sm:min-w-16">
                      ...
                      {vehicle.repairPriorityClass}
                      </div>
                      </TableCell>
                    <TableCell className="">{vehicle.maintenanceTasks}</TableCell>
                    
                    <TableCell className="">{vehicle.issueDate}</TableCell>
                    <TableCell className="">{vehicle.expectedDate}</TableCell>
                    <TableCell className="">
                    <div className="flex items-center gap-2">
                    <Avatar className="w-6 h-6">
                      <AvatarImage src="/api/placeholder/30/30" alt="Avatar" />
                      <AvatarFallback className="bg-purple-700 text-white text-xs">JS</AvatarFallback>
                    </Avatar>
                    <span className="text-zinc-300">{vehicle.assignedTo}</span>
                  </div>
                    </TableCell>
