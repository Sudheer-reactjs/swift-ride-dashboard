...
const MaintenanceProgramsTable: React.FC<VehicleTableProps> = ({
  vehicles,
  isOpen,
  toggleFilterPanel,
}) => {
    ...
    <>
      <div className="w-full relative overflow-hidden">
        ...
        <div className="w-full overflow-auto rounded-lg border bg-[#171717] border-[#27272A]">
          <Table className="w-full overflow-auto hover:cursor-pointer min-w-[700px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="">Schedules</TableHead>
                <TableHead className="">Primary Meter</TableHead>
                <TableHead className="">Secondary Meter</TableHead>
            ...
            <TableBody>
              {paginatedVehicles.map((vehicle, index) => (
                <Link
                  key={index}
                  href={`/maintenance-programs/${vehicle.vin}`}
                  passHref
                  legacyBehavior
                >
                  <TableRow key={index} className="bg-black-800 text-xs">
                    ...
                    <TableCell className="">{vehicle.vehicle}</TableCell>
                    <TableCell className="">{vehicle.schedules}</TableCell>
                    <TableCell className="">{vehicle.primaryMeter} </TableCell>
                    <TableCell className="">{vehicle.secondaryMeter}</TableCell>
...
export default MaintenanceProgramsTable;
