...
const InspectionHistoryTable: React.FC<VehicleTableProps> = ({
  vehicles,
  isOpen,
  toggleFilterPanel,
}) => {
          ...
          <Table className="w-full overflow-auto hover:cursor-pointer min-w-[1300px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="">Vehicle Group</TableHead>
                <TableHead className="">Submitted</TableHead>
                <TableHead className="">Duration</TableHead>
                <TableHead className="">Inspection Form</TableHead>
                <TableHead className="">User</TableHead>
                <TableHead className="">Location Exception</TableHead>
                <TableHead className="">Failed Items</TableHead>
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button className="bg-transparent border-0 hover:bg-transparent p-0 h-auto">
                              <VehicleGroupIcon />
                            </Button>
                          </TooltipTrigger>
                          <TooltipContent className="max-w-64 w-full text-center bg-[#09090b] text-white">
                            {vehicle.vehicleGroupTooltip}
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                     
                    </TableCell>
                    <TableCell className="">{vehicle.submitted}</TableCell>
                    <TableCell className="">{vehicle.duration}</TableCell>
                    <TableCell className="">{vehicle.inspectionForm}</TableCell>
                    ...
                    <TableCell className="">
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="max-w-64 w-full text-center bg-[#09090b] text-white">
                            {vehicle.locationException}
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </TableCell>
                    
                    <TableCell className="">{vehicle.failedItems}</TableCell>
                    <TableCell className="flex gap-2">
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
