          ...
          <Table className="w-full overflow-auto hover:cursor-pointer min-w-[1300px]">
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="">Next Due</TableHead>
                <TableHead className="">Last Inspected</TableHead>
                <TableHead className="">Schedule</TableHead>
                <TableHead className="">Frequency </TableHead>
                <TableHead className="">Manually Overridden </TableHead>
              ...
              {vehicles.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={9} className="text-center">
                    <div className="w-full flex flex-col gap-5 justify-center items-center px-5 py-28 text-neutral-400 text-sm font-normal max-w-[550px] m-auto text-center">
                      <Image
                      ...
                      <p>
                        Inspection Schedules ensure assets are in good condition and meet
                ...
                paginatedVehicles.map((vehicle, index) => (
                  ...
                  >
                    <TableRow key={index} className="bg-black-800 text-xs">
                      ...
                      <TableCell className=""> {vehicle.nextDue}</TableCell>
                      <TableCell className="">{vehicle.lastInspected}</TableCell>
                      <TableCell className="">{vehicle.schedule}</TableCell>
                      <TableCell className="">{vehicle.frequency}</TableCell>
                      <TableCell className="">
                        {" "}
                        {vehicle.manuallyOverridden}
                      </TableCell>
