...
import { ExternalLinkIcon, Lock, Info } from "lucide-react";
const Details = () => {
    ...
    <div>
      <div className="bg-[#171717] p-6 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Telematics Device */}
          <div className="col-span-2">
            <Label className="text-sm text-gray-100">Telematics Device</Label>
          ...
          <div>
            ...
            <Input
              ...
              className="mt-1 bg-black text-white border-gray-700"
            />
            <p className="text-sm mt-1 text-gray-500">e.g. 1999, 2012, etc.</p>
          </div>
          <div>
          ...
          <div>
            <Label className="col-span-2 text-sm text-gray-400">Labels</Label>
            <Select>
              <SelectTrigger className="mt-1 bg-black text-white border-gray-700">
                <SelectValue placeholder="Please Select" />
              </SelectTrigger>
