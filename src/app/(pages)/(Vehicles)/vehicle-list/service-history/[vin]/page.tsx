...
const page = () => {
  return (
    <div className="flex w-full flex-col gap-6 size-span">
      ...
      <h2 className="text-neutral-50 text-2xl md:text-3xl font-bold">Service Entry #52839203</h2>
    ...
    <div className="flex w-full col-span-12 gap-1 relative min-h-screen">
      <div className="grid grid-cols-12 gap-4 relative max-w-[calc(100%-52px)]">
        ...
        <div className="col-span-12 lg:col-span-8">
          {/* centre  */}
          <Card className="bg-[#171717] text-white rounded-lg shadow-lg">
          <CardHeader className="p-4">
              <div className="flex justify-between items-center">
            ...
            <CardContent className="p-4 pt-0">
                ...
                <table className="w-full min-w-[600px]">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={i} className="border-b border-neutral-700 text-neutral-50 text-xs font-normal">
              ...
              <div className="space-y-6 max-w-80 ml-auto ">
                <div className="justify-end grid grid-cols-12 gap-4 w-full">
                  <span className="text-neutral-50 text-sm font-semibold col-span-6">Subtotal</span>
                  <span className="text-neutral-50 text-sm font-semibold col-span-6 text-right">$94.88</span>
                </div>
                ...
                <div className=" text-neutral-50 text-sm font-semibold grid grid-cols-12 gap-4 w-full pt-4 border-t border-neutral-700">
                 <span className="text-neutral-50 text-sm font-semibold col-span-6">Discount (0.0%)</span>
                  <span className="text-neutral-50 text-sm font-semibold col-span-6 text-right">-$0.00</span>
                </div>
                ...
                <span className="text-neutral-50 text-sm font-semibold col-span-6">Tax (0.0%)</span>
                <span className="text-neutral-50 text-sm font-semibold col-span-6 text-right">-$0.00</span>
                </div>
                <div className=" text-neutral-50 text-sm font-semibold grid grid-cols-12 gap-4 w-full">
                <span className="text-neutral-50 text-sm font-semibold col-span-6">Total</span>
                <span className="text-neutral-50 text-sm font-semibold col-span-6 text-right">$94.88</span>
                </div>
              </div>
              </div>
